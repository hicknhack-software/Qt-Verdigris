...
public:
    ...
    W_DECLARE_FLAGS(Flags32, Flag32);
    W_DECLARE_FLAGS(Flags64, Flag64);
    W_ENUM(UnsignedEnum, UnsignedValue1, UnsignedValue2);
    W_ENUM(SignedEnum64, SignedValue64_0, SignedValue64_1, SignedValue64_Large, SignedValue64_M1);
    W_ENUM(UnsignedEnum64, UnsignedValue64_0, UnsignedValue64_1, UnsignedValue64_Large, UnsignedValue64_Max);
    W_FLAG(Flags32, Flag32_1, Flag32_2);
    W_FLAG(Flags64, Flag64_1, Flag64_2, Flag64_3);
#endif

private:
    void fromType(); W_SLOT(fromType);
#if QT_VERSION >= QT_VERSION_CHECK(6,9,0)
    void keyToValue_data(); W_SLOT(keyToValue_data);
    void keyToValue(); W_SLOT(keyToValue);
#endif
